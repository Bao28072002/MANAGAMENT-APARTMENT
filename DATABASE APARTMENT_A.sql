...
VALUES 
    ('user1', '1234', 'user1@gmail.com', 'user', 1),
    ('user2', '1234', 'user2@gmail.com', 'user', 0),
	 ('user3', '1234', 'user3@gmail.com', 'user', 1),
    ('user4', '1234', 'user4@gmail.com', 'user', 0),
    ('user5', '1234', 'user5@gmail.com', 'user', 1),
    ('user6', '1234', 'user6@gmail.com', 'user', 1),
    ('user7', '1234', 'user7@gmail.com', 'user', 0),
    ('user8', '1234', 'user8@gmail.com', 'user', 1),
    ('user9', '1234', 'user9@gmail.com', 'user', 0),
    ('user10', '1234', 'user10@gmail.com', 'user', 1),
	('user11', '1234', 'user11@gmail.com', 'user', 1),
    ('user12', '1234', 'user12@gmail.com', 'user', 0),
    ('user13', '1234', 'user13@gmail.com', 'user', 1),
    ('user14', '1234', 'user14@gmail.com', 'user', 0),
    ('user15', '1234', 'user15@gmail.com', 'user', 1),
    ('user16', '1234', 'user16@gmail.com', 'user', 0),
    ('user17', '1234', 'user17@gmail.com', 'user', 1),
    ('user18', '1234', 'user18@gmail.com', 'user', 1),
    ('user19', '1234', 'user19@gmail.com', 'user', 0),
    ('user20', '1234', 'user20@gmail.com', 'user', 1);
go
...
VALUES 
	...
	(4, 'Le Van C', 'Payment Issue', 'I was charged twice for the same service.'),
    (5, 'Pham Thi D', 'App Crash', 'The app crashes when I try to update my profile.'),
    (6, 'Hoang Van E', 'Slow Response', 'It takes too long to get a reply from customer support.'),
    (7, 'Do Thi F', 'Feature Request', 'Please add dark mode to the application.'),
    (8, 'Nguyen Van G', 'Bug Report', 'The notification system is not working properly.'),
    (9, 'Tran Thi H', 'Login Issue', 'I cannot reset my password even after entering the correct email.'),
    (10, 'Bui Van I', 'Service Request', 'Can you provide more payment options?'),
    (11, 'Dang Thi K', 'UI Improvement', 'The user interface is too cluttered and needs improvement.');
GO

INSERT INTO Feedback ( memberID, namefb, feedbackTittle, note, FeedbackDate, Statusfb)
VALUES 
    ( 2, 'Nguyen Van A', 'System Error', 'I encountered an error while logging into the system.', '2025-03-10', 0),
    ( 3, 'Tran Thi B', 'Poor Service', 'The support staff responds very slowly.', '2025-03-10', 0),
    ( 4, 'Le Van C', 'Payment Issue', 'I was charged twice for the same service.', '2025-03-10', 0);
